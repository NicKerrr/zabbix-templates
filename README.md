...
| Template                 | Способ сбора                     |
| ------------------------ | -------------------------------- |
| Lenovo Storage DE Series | HTTP API                         |
| Reg.ru                   | HTTP API                         |
| VMware Replication       | REST API                         |
| LibreHardwareMonitor     | HTTP API                         |
| NVR                      | External Python script + CGI API |
| KeeneticOS               | SNMP                             |
...
| `Reg.ru by HTTP`                   | Monitoring Reg.ru domains and hosting services via HTTP API. Discovers domains and hosting services, collects creation/expiration dates and service state, and creates expiration alerts.         | 7.4+       |
...
| `LibreHardwareMonitor by HTTP`     | Monitoring Windows hardware sensors via LibreHardwareMonitor HTTP API: CPU, GPU, NVMe, HDD/SSD temperatures and fan speeds.                                                                       | 7.4+       |
...
| `KeeneticOS by SNMP`               | Monitoring Keenetic / KeeneticOS routers via SNMP: ICMP/SNMP availability, system information, uptime, CPU, memory and network interfaces.                                                        | 7.4+       |
